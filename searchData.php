...
// ຄຳສັ່ງໃນການຄົ້ນຫາ ຊື່ ທີ່ມີສວນປະກອບເປັນຊື່ທີ່ສົ່ງມາ
    ...
    <table class="table table-dark table-striped"> 
        ...
        <?php } else {?>
            <div class="alert alert-danger text-center" role="alert">
                <h5><b>ບໍ່ພົບຂໍ້ມູນຂອງພະນັກງານທີ່ຄົ້ນຫາ !!!</b></h5>
            </div>

          <?php } ?>

    <a href="insertform.php" class="btn btn-success mb-3">ບັນທຶກຂໍ້ມູນຂອງພະນັກງານ</a>
            <a href="showdata_table.php" class="btn btn-primary mb-3">ກັບໄປໜ້າແລກ</a>
